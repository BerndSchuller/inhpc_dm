/** Modified BreadCrumbs class and namespace from @jupyterlab/filebrowser
...
import { dm_FileBrowserModel } from './mod_model';
 ...
 */
export class dm_BreadCrumbs extends Widget {
  /**
   * Construct a new file browser crumb widget.
   *
   * @param model - The file browser view model.
   */
  constructor(options: dm_BreadCrumbs.IOptions) {
    super();
  ...
  handleEvent(event: Event): void {
    switch (event.type) {
      ...
      case 'lm-dragover':
        ...
        break;
      case 'lm-drop':
		console.log("Crumbs.Drop Event: ", event);
  ...
  private _model: dm_FileBrowserModel;
 ...
 */
export namespace dm_BreadCrumbs {
  /**
