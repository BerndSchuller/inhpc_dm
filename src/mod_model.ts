 ...
 */
export class dm_FileBrowserModel implements IDisposable {
  /**
   * Construct a new file browser model.
   */
  constructor(options: dm_FileBrowserModel.IOptions) {
...
//	console.log(" ");
//	console.log("cd start (newValue): ", newValue, ", root path: ", this.rootPath, ", path: ", this.path, ", driveName: ", this.driveName);
	//console.log(": ", );
...
//	  console.log("cd if: ", tmp, " resolves to ", newValue);
//	  console.log("cd if (newValue): ", newValue);
    } else {
      newValue = this._pendingPath || this._model.path;
//	  console.log("cd else (newValue): ", newValue);
    }
    if (this._pending) {
...
//	console.log("cd (oldValue): ", oldValue, "(newValue): ", newValue);
 ...
 */
export class dm_TogglableHiddenFileBrowserModel extends dm_FileBrowserModel {
  constructor(options: dm_TogglableHiddenFileBrowserModel.IOptions) {
    super(options);
 ...
 */
export namespace dm_TogglableHiddenFileBrowserModel {
  /**
   * Constructor options
   */
  export interface IOptions extends dm_FileBrowserModel.IOptions {
    /**
 ...
 */
export class dm_FilterFileBrowserModel extends dm_TogglableHiddenFileBrowserModel {
  constructor(options: dm_FilterFileBrowserModel.IOptions) {
    super(options);
 ...
 */
export namespace dm_FilterFileBrowserModel {
  /**
   * Constructor options
   */
  export interface IOptions extends dm_TogglableHiddenFileBrowserModel.IOptions {
    /**
